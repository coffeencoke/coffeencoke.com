...
function wp_list_categories( $args = '' ) {
    ...
    'feed_image' => '', 'exclude' => wp_list_excluded_category_ids(), 'exclude_tree' => '', 'current_category' => 0,
...
function wp_list_excluded_category_ids(){
       return wp_portfolio_page_id();
}
function wp_portfolio_page_id(){
       return 11;
}
