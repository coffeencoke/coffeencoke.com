...
<div id="respond">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p>
			<label for="author">
				Name <?php if ($req) echo "<span class='note'>(required)</span>"; ?>
			</label>
			<br />
		...
		<p>
			<label for="email">
				Mail <?php if ($req) echo "<span class='note'>(required)</span>"; ?>
			</label>
			<br />
		...
		<p>
			...
			<br />
			<span class='note'>must begin with "http://"</span>
		</p>
		<?php endif; ?>
		<p>
			<label for="comment">
...
<div id='comments_container' class='blue box'>
