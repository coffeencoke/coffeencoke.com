...
Donate link: http://stephanreiter.info/donate
...
If you have translated the plugin into another language and wish to see the corresponding language files bundled with Scissors, feel free to contact me at [stephan.reiter@gmail.com](mailto:stephan.reiter@gmail.com). Also, if you would like to contribute to Scissors' code base by implementing a new feature or by fixing a bug, feel free to send me patches for the code. I'd like to explicitly mention Samuel Aguilera, who was the first to supply a series of code enhancements. Thanks a lot for your help! That's the open source spirit.
