...
Plugin URI: http://stephanreiter.info/2008/10/wordpress-plugin-scissors/
...
{
	$filename = path_join(ABSPATH, get_option('scissors_watermark_path'));
...
{
	$result = FALSE;
	$watermark_path = path_join(ABSPATH, get_option('scissors_watermark_path'));
