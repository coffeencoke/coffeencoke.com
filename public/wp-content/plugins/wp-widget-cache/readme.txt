...
[ChangeLog](http://www.mashget.com/2008/09/05/wp-widget-cache-changelog/)
...
That depends on how many and what widgets you use, for [www.mashget.com](http://www.mashget.com), the queries for home page reduce from from 69 to 19, that's means **70%** improvement.
...
After using the WP Widget Cache, I think you'll find the number of 'queries' reducing a lot. Of course, that will depend on how many and what widgets you use.  For this site, <a href="http://www.mashget.com">www.mashget.com</a> , the number reduce from 69 to 19, that's means **70%**, really a big improvement.
...
Here's a list of such widgets to be finished, if you know something new, just visit [here](http://www.mashget.com/2008/09/01/wp-widget-cache-for-wordpress/), and leave a comment.
